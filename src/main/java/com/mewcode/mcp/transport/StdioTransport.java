    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[mewcode] stdout reader stopped: " + e.getMessage());
            }
        }, "mewcode-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[mewcode] stderr reader stopped: " + e.getMessage());
            }
        }, "mewcode-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
