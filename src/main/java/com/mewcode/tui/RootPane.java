...
import com.mewcode.tui.pane.FileTreePane;
import com.mewcode.tui.pane.InputBar;
...
public class RootPane extends Panel {
     ...
     */
    public RootPane(MewCodeConfig config, LlmClient llmClient) {
        super();
    ...
    public boolean handleInput(KeyStroke keyStroke) {
        ...
        if (keyStroke.getKeyType() == KeyType.Character && keyStroke.isCtrlDown() && keyStroke.getCharacter() == 'P') {
            centerPane.appendSystemMessage("对话历史已持续保存到 ~/.mewcode/history/。");
            return true;
        }
