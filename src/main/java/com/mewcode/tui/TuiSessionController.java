...
import com.mewcode.hitl.HitlHandler;
...
import com.mewcode.tui.history.ConversationSnapshot;
import com.mewcode.tui.pane.CenterPane;
import com.mewcode.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final MewCodeConfig config;
    ...
    public TuiSessionController(MewCodeConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "mewcode-tui-agent-runner");
