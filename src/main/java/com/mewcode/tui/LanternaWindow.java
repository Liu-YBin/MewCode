...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(MewCodeConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("MewCode v16.0.0");
    ...
    public MewCodeConfig getConfig() {
        return config;
    }
}
