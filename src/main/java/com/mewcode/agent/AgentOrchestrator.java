...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.mewcode.skill.SkillRegistry skillRegistry,
                               com.mewcode.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "mewcode-multi-agent");
            t.setDaemon(true);
            return t;
        });
