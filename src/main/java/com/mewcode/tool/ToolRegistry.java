...
import com.mewcode.browser.BrowserAuditMetadata;
import com.mewcode.browser.BrowserCheckResult;
import com.mewcode.browser.BrowserConnector;
import com.mewcode.browser.BrowserGuard;
import com.mewcode.context.ContextProfile;
import com.mewcode.lsp.LspDiagnosticReport;
import com.mewcode.lsp.LspManager;
import com.mewcode.mcp.protocol.McpToolDescriptor;
import com.mewcode.policy.AuditLog;
import com.mewcode.policy.CommandGuard;
import com.mewcode.policy.PathGuard;
import com.mewcode.policy.PolicyException;
import com.mewcode.rag.CodeRetriever;
import com.mewcode.rag.SearchResultFormatter;
import com.mewcode.rag.VectorStore;
import com.mewcode.runtime.CancellationContext;
import com.mewcode.skill.Skill;
...
public class ToolRegistry {
    ...
    private static final Set<String> SEARCH_EXCLUDED_DIRS = Set.of(
            ".git", ".mewcode", "target", "node_modules", "dist", "build", "coverage", ".idea", ".gradle"
    );
     ...
     * 获取所有工具定义（用于LLM）
     */
    public List<com.mewcode.llm.LlmClient.Tool> getToolDefinitions() {
        return tools.values().stream()
                .map(t -> new com.mewcode.llm.LlmClient.Tool(t.name(), t.description(), t.parameters()))
                .toList();
    }
    ...
    public List<ToolExecutionResult> executeTools(List<ToolInvocation> invocations) {
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread thread = new Thread(r, "mewcode-tool-executor");
    ...
    private String executeCommand(String command) {
        ...
        ExecutorService outputReaderExecutor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "mewcode-command-output");
            thread.setDaemon(true);
            return thread;
        });
    ...
    public record ToolExecutionResult(String id, String name, String argumentsJson,
                                      ...
                                      List<com.mewcode.llm.LlmClient.ContentPart> imageParts) {
