...
public class LongTermMemory implements Memory {
    ...
    private static final String STORAGE_DIR_PROPERTY = "mewcode.memory.dir";
    private static final String STORAGE_DIR_ENV = "MEWCODE_MEMORY_DIR";
    ...
    private static File resolveStorageDir() {
        ...
        return UserHome.path().resolve(".mewcode").resolve("memory").toFile();
    }
