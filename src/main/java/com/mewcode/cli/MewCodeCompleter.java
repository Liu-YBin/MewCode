...
import com.mewcode.mcp.mention.AtMentionCompleter;
...
final class MewCodeCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    MewCodeCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
