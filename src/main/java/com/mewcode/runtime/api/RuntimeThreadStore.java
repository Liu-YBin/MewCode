...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("mewcode.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("MEWCODE_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = UserHome.path().resolve(".mewcode").resolve("runtime").toString();
        }
